...
```{r Multicollinearity, echo=F, include=T, warning=F, fig.height = 5, fig.width = 6}
...
```{r Probabilities, echo=F, include=T, warning=F, fig.height = 3, fig.width = 5, fig.align="center"}
